...
addCol: begin
    ...
    select count(1) into colFound
        ...
        where table_schema = 'T20' and lower(table_name) = lower(i_tableName) and COLUMN_NAME = colName;
...
addCons: begin
    ...
    select count(1) into consFound
        ...
        where constraint_schema = 'T20' and constraint_schema = table_schema and
...
dropCol: begin
    ...
    */
    ...
    select count(1) into colFound
        from information_schema.COLUMNS
        where table_schema = 'T20' and lower(table_name) = lower(i_tableName) and upper(COLUMN_NAME) = colName;
